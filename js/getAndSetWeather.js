//This function puts in the default weather cards for San Antonio
...
//This function empty's the previous weatherCards div and pushes updated weather cards when the button is pushed
...
//This function empty's the previous weatherCards div and pushes updated weather cards when the pin on the map is moved
function hoverWeather(lngLat){
    $.get("http://api.openweathermap.org/data/2.5/weather", {
        APPID: OPEN_WEATHER_APPID,
        lat: lngLat.lat,
        lon: lngLat.lng,
